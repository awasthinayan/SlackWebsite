...
router.use("/V1/workspaces/createWorkspace",validate(WorkspaceSchema),V1CreateWorkspace);
router.use("/V1/workspaces/updateWorkspace",validate(WorkspaceSchema),V1updateWorkspace);
router.use("/V1/workspaces/deleteWorkspace",validate(WorkspaceSchema),V1deletWorkspace);
...
router.use("/V1/workspaces/addMemberToWorkspace",validate(WorkspaceSchema),V1addMemberToWorkspace);
router.use("/V1/workspaces/addChannelToWorkspace",validate(WorkspaceSchema),V1addChannelToWorkspace);
router.use("/V1/workspaces/fetchAllWorkspaceByMemberId",V1fetchAllWorkspaceByMemberId);   
